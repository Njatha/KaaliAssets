<x-layout>
    ...
    <x-card>
            ...
            <dl class="max-w-screen text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                <div class="flex flex-col pb-3">
                    <dt class="mb-1 text-gray-500 md:text-sm dark:text-gray-400">{{$assetHistory->created_at}}</dt>
                    <dd class="text-sm font-semibold">{{$assetHistory->description}}</dd>
                </div>
            </dl>
            @endforeach
